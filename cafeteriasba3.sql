...
-- ----------------------------
INSERT INTO `t_cafeteria` VALUES ('1', 'All Saints Cafe', 'Ciudad de la Paz 2300', '47060016', 'allsaints@gmail.com', 'allsaintscafe.com.ar', 'Belgrano', '08:00:00', '22:00:00', '5', '1', 'activo');
...
INSERT INTO `t_nota` VALUES ('2', 'CONOCÉ EL CAFÉ MÁS CARO DEL MUNDO', 'Se trata del Kopi Luwak, que se vende en las mejores cafetarías de Nueva York a 40 dólares la taza. Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creación de las hojas \"Letraset\", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.', '2018-11-13', 'activo', '1');
...
INSERT INTO `t_usuario` VALUES ('3', 'All Saints', 'Cafe', 'allsaints@gmail.com', '$2y$10$lEaOPL67JEkhBTpd0Hb90OhpdmpEB/aJGJJW8U0iLr4TF6ACEfaHe', '2018-11-11', 'activo', 'cafe_2.jpg', '3', '1');
INSERT INTO `t_usuario` VALUES ('4', 'Testing', 'Usuario', 'test@gmail.com', '$2y$10$.tpYs18/r5RRhPo3G6ttRuRvJ39KMTmr4q0VD/e4sQcVh.q4jw4M.', '2018-11-13', 'activo', 'testing.jpg', '2', '1');

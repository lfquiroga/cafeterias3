        ...
        if(isset($postData['cargarComentario'])){                                
            ...
            foreach ($comentarios_db as $row){
                ...
                if($_SESSION['Id']==$user->getId()){
                         ...
                         $comentarios.='<div class="bntdltcont"><i class="fas fa-trash-alt icnfawsm"></i><input type="button" value="Eliminar" class="eliminar_comentario" id="eliminar_'.$row->getId().'"></div>';
           ...
           if($contador > 5){
                 $comentarios.='<div class="bntdltcont vermascontinr"><i class="fas fa-plus icnfawsm"></i><input type="button" value="Ver más" max="'.$contador.'" class="ver_mas" id="0"></div>';
           }

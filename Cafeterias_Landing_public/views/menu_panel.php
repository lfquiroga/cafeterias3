...
<body>
  ...
  <div class="container1200max">
    ...
    <a id="dashboard" style="height: 60px;" href="index.php"><img width="64" src="../img/logoCafeteriasBAb.svg" alt="logoCafeteriasBA"></a>
        <a class="navitem" href="../index.php">Home</a>
    <a  class="navitem" id="cafeterias" href="#">Abm Cafeterías</a>
    <a  class="navitem" id="sugerencias" href="#">Abm Sugerencias</a>    
    <a  class="navitem" id="productos" href="#">Abm Productos</a>
    <a  class="navitem" id="usuarios" href="#">Abm Usuarios</a>
    
    <?php
        }else if($_SESSION['Rol'] == 2 || $_SESSION['Rol'] == 3){
    ?>
    
    <a id="dashboard" href="index.php"><img width="64" src="../img/logoCafeteriasBAb.svg" alt="logoCafeteriasBA"></a>
        <a class="navitem" href="../index.php">Home</a>
    <a id="cafeterias" href="perfilUser.php">Mis datos</a>
     <?php
        if($_SESSION['Rol'] == 3){
            ?>
    <a id="menu" href="menuCafeteria.php">Menu cafeteria</a>
    <?php
        }

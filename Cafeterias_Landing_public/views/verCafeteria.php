...
<main>
  ...
  <div class="page-bg">
    <div class="page-bg-wrapper">
      <h1 id="titulo"></h1>
      <!--p>Especialistas en caf&eacute; y un ambiente ténico</p-->
    </div>
  </div>
          ...
          <div class="rowcontainertxt" style="display:none;">
            <div class="co12">
              ...
              <p>All Saints Caf&eacute; cree en la calidad sobre todas las cosas. Compran directamente a peque&ntilde;os podructores cafeteros alrededor del mundo. El caf&eacute; utilizado 
                proviene de microlotes de origen Ãºnico, en lo posible org&aacute;nicos y sustentables, de la mas alta calidad puntuados en cata de 84 puntos en adelante.</p>

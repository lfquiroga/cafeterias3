...
<html lang="es">
  ...
  <body>
    ...
    <div class="wrapper contheadhomepage">      <div class="top-default contlogohomepage">        <div class="logoCafeteriasBA">          <a href="index.php">            <img src="img/logoCafeteriasBA.svg">          </a>        </div>	</div>
        ...
        <header class="headmnhome"> 
          ...
          <div class="topnav" id="myTopnav">
            ...
            <div class="container1200max">
              ...
              <a class="navitem" href="views/productos.php">Productos</a>	
              ...
              if (isset($_SESSION['Usuario'])) {
                ...
                if (isset($_SESSION['Rol'])) {
                  ...
                  <a href="#" class="usrmnbtns loginLink">Ingresar</a>
